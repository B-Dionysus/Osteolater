...
boolean Adafruit_VS1053_FilePlayer::startPlayingFile(const char *trackname, unsigned long startPosition) {
  // reset playback
...
//    Serial.println(startPosition);
    if(!currentTrack.seek(startPosition)) Serial.print("Error: Trying to seek() past the end of the file!");
